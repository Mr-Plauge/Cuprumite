...
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-2 ~ #cuprumite:air run teleport ~ ~-1 ~
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-2 ~ #cuprumite:usable_copper if block ~ ~-3 ~ #cuprumite:air run teleport ~ ~-1 ~
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-2 ~ #cuprumite:usable_copper if block ~ ~-3 ~ #cuprumite:usable_copper if block ~ ~-4 ~ #cuprumite:air run teleport ~ ~-1 ~
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-2 ~ #cuprumite:usable_copper if block ~ ~-3 ~ #cuprumite:usable_copper if block ~ ~-4 ~ #cuprumite:usable_copper if block ~ ~-5 ~ #cuprumite:air run teleport ~ ~-1 ~
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-2 ~ #cuprumite:usable_copper if block ~ ~-3 ~ #cuprumite:usable_copper if block ~ ~-4 ~ #cuprumite:usable_copper if block ~ ~-5 ~ #cuprumite:usable_copper if block ~ ~-6 ~ #cuprumite:air run teleport ~ ~-1 ~
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-2 ~ #cuprumite:usable_copper if block ~ ~-3 ~ #cuprumite:usable_copper if block ~ ~-4 ~ #cuprumite:usable_copper if block ~ ~-5 ~ #cuprumite:usable_copper if block ~ ~-6 ~ #cuprumite:usable_copper if block ~ ~-7 ~ #cuprumite:air run teleport ~ ~-1 ~
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-2 ~ #cuprumite:usable_copper if block ~ ~-3 ~ #cuprumite:usable_copper if block ~ ~-4 ~ #cuprumite:usable_copper if block ~ ~-5 ~ #cuprumite:usable_copper if block ~ ~-6 ~ #cuprumite:usable_copper if block ~ ~-7 ~ #cuprumite:usable_copper if block ~ ~-8 ~ #cuprumite:air run teleport ~ ~-1 ~
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-2 ~ #cuprumite:usable_copper if block ~ ~-3 ~ #cuprumite:usable_copper if block ~ ~-4 ~ #cuprumite:usable_copper if block ~ ~-5 ~ #cuprumite:usable_copper if block ~ ~-6 ~ #cuprumite:usable_copper if block ~ ~-7 ~ #cuprumite:usable_copper if block ~ ~-8 ~ #cuprumite:usable_copper if block ~ ~-9 ~ #cuprumite:air run teleport ~ ~-1 ~
