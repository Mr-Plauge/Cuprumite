...
execute if score @s rotation_x matches -45.. if score @s rotation_x matches ..45 run scoreboard players set @s direction_x 1
...
execute if score @s direction_x matches 0 run scoreboard players set @s direction_x 4

### setting direction_y's value based on rotation_y's value (1 is up, 2 is forward, 3 is down)
execute if score @s rotation_y matches ..-60 if score @s rotation_y matches -90.. run scoreboard players set @s direction_y 1
execute if score @s rotation_y matches ..60 if score @s rotation_y matches -60.. run scoreboard players set @s direction_y 2
execute if score @s direction_y matches 0 run scoreboard players set @s direction_y 3
