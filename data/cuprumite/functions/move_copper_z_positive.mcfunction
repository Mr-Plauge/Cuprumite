...
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-1 ~1 #cuprumite:usable_copper if block ~ ~-1 ~2 #cuprumite:air run teleport ~ ~ ~1
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-1 ~1 #cuprumite:usable_copper if block ~ ~-1 ~2 #cuprumite:usable_copper if block ~ ~-1 ~3 #cuprumite:air run teleport ~ ~ ~1
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-1 ~1 #cuprumite:usable_copper if block ~ ~-1 ~2 #cuprumite:usable_copper if block ~ ~-1 ~3 #cuprumite:usable_copper if block ~ ~-1 ~4 #cuprumite:air run teleport ~ ~ ~1
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-1 ~1 #cuprumite:usable_copper if block ~ ~-1 ~2 #cuprumite:usable_copper if block ~ ~-1 ~3 #cuprumite:usable_copper if block ~ ~-1 ~4 #cuprumite:usable_copper if block ~ ~-1 ~5 #cuprumite:air run teleport ~ ~ ~1
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-1 ~1 #cuprumite:usable_copper if block ~ ~-1 ~2 #cuprumite:usable_copper if block ~ ~-1 ~3 #cuprumite:usable_copper if block ~ ~-1 ~4 #cuprumite:usable_copper if block ~ ~-1 ~5 #cuprumite:usable_copper if block ~ ~-1 ~6 #cuprumite:air run teleport ~ ~ ~1
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-1 ~1 #cuprumite:usable_copper if block ~ ~-1 ~2 #cuprumite:usable_copper if block ~ ~-1 ~3 #cuprumite:usable_copper if block ~ ~-1 ~4 #cuprumite:usable_copper if block ~ ~-1 ~5 #cuprumite:usable_copper if block ~ ~-1 ~6 #cuprumite:usable_copper if block ~ ~-1 ~7 #cuprumite:air run teleport ~ ~ ~1
execute as @e[distance=..4] run execute as @s at @s if block ~ ~-1 ~ #cuprumite:usable_copper if block ~ ~-1 ~1 #cuprumite:usable_copper if block ~ ~-1 ~2 #cuprumite:usable_copper if block ~ ~-1 ~3 #cuprumite:usable_copper if block ~ ~-1 ~4 #cuprumite:usable_copper if block ~ ~-1 ~5 #cuprumite:usable_copper if block ~ ~-1 ~6 #cuprumite:usable_copper if block ~ ~-1 ~7 #cuprumite:usable_copper if block ~ ~-1 ~8 #cuprumite:air run teleport ~ ~ ~1
